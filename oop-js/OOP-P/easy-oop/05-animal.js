...
The Cat constructor should take 3 arguments, name, age and status. Cats should always have 
a leg count of 4 and a species of cat. Also, the introduce method 
should be identical to the original except, after the phrase there 
...
class Dog extends Animal{
	...
	greetMaster(){
		return super.introduce() + " Hello " + this.master +"!" + " Woof, woof!";
	}

}

let cat = new Cat("Pepe", 2, "happy");
let dog = new Dog("Brain",4, "happy","Peter");
